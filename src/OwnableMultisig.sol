...
contract OwnableMultisig is Context {
    ...
    uint256 internal _unblockBitmap; // bitmap for the unblock transaction
    uint256 internal _changeOwnerBitmap; // bitmap for the change owner transaction
    uint256 internal _abortChangeOwnerBitmap; // bitmap for the abort change owner transaction
    uint256 internal _changeSignerBitmap; // bitmap for the change signer transaction
    uint256 internal _abortChangeSignerBitmap; // bitmap for the abort change signer transaction
    uint256 internal _replacedSignerIndex; // the index of the replaced signer
